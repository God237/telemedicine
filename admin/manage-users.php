...
$active_users_sql = "SELECT COUNT(*) as total FROM users WHERE status = 'approved' OR status IS NULL";
$active_users_result = $conn->query($active_users_sql);
$active_users = $active_users_result ? $active_users_result->fetch_assoc()['total'] : 0;
?>
...
<head>
    ...
    <title>Manage Users | Admin Dashboard | TeleMed Cameroon</title>
...
<body>
    ...
    <section class="dashboard">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li onclick="window.location.href='manage-users.php'" class="active">
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card active" onclick="applyFilter('all', 'approved')">
                    <i class="fas fa-check-circle"></i>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <a href="edit-user.php?id=<?php echo $user['id']; ?>" class="btn-icon btn-edit">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <button onclick="showDeleteModal(<?php echo $user['id']; ?>, '<?php echo addslashes($user['name']); ?>')" class="btn-icon btn-delete">
            ...
            <!-- Pagination (Optional - can be enhanced) -->
    ...
    <script>
        ...
        function showDeleteModal(userId, userName) {
            deleteUserId = userId;
            const message = `Are you sure you want to delete ${userName}? This will permanently remove their account and all associated data.`;
